...
export async function getStaticProps() {
  ...
  return {
    props: {
      cover:
        'https://free4kwallpapers.com/uploads/originals/2019/06/11/cyberpunk---x--wallpaper.jpg',
      gameInfo: {
        title: 'Cyberpunk 2077',
        price: '59.00',
        description:
          'Cyberpunk 2077 is an open-world, action-adventure story set in Night City, a megalopolis obsessed with powe, glamour and body modification. You play as V, a mercenary outlaw going after a one-of-a-kind implant that is the key to imortality'
      },
      gallery: galleryMock,
